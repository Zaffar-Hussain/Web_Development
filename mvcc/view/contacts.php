...
<html>
    <head>
        ...
        <script type="text/javascript">
            function select_all() {
                var tick = document.getElementById('ch');
        ...
        <table class="contacts" border="0" cellpadding="0" cellspacing="0">
            <thead>
                <tr>
                    ...
                    <th>type1</th>
                    <th>type2</th>
                    <th>SelectAll<input type=checkbox id=select_all value="1" onclick="select_all()"></th>
                </tr>
            </thead>
            <tbody>
            <?php 
            ...
            ?>
                ...
                <tr>
                    ...
                    <td><input type=checkbox id="ch" value="$contact->id" ></td>           
                </tr>
            <?php endforeach; ?>
            </tbody>
        </table><br><br>
