...
<body style="background-color:#81ecec">
	...
	<div id="main-wrapper">
	<center><h2>Delete Employee Details Form</h2></center>
	
		
	<form class="myform" action="del_s.php" method="post">
	...
	<input name="submit_btn" type="submit" id="submitt_btn" value="Delete"/><br>
	<a href="delete_emp.php"><input name="logout" type="button" id="logout_btn" value="Back"/></a><br>
	...
	if(isset($_POST['submit_btn']))
	{
		...
		if($ssn==$cssn)
		{
			...
			{	
				$p=$_SESSION['ssn'];
				$query="DELETE * from emp_details  WHERE ssn='$p' LIMIT 1";
				$query_run=mysqli_query($conn,$query);
