...
<input type="radio" name=food value = breakfast onclick="this.form.submit()">Breakfast
<input type="radio" name=food value = lunch onclick="this.form.submit()">lunch
<input type = "radio" name=food value=dinner onclick="this.form.submit()">Dinner
...
<?php
		...
		{
			if($_REQUEST['food']=='breakfast'){
				

			}
			else if($_REQUEST['food']=='lunch'){
