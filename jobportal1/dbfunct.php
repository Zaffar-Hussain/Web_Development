<?php
	...
	function deleteCand($delete)
	{
		$conn=connection();
		$sql="delete from selection_info where sid='$delete'";
		//echo $sql."<br>";
		$result=mysqli_query($conn,$sql);
		closeconnection($conn);
	}

	function deleteJob($delete)
	{
		$conn=connection();
		$sql="delete from application_info where appl_id='$delete'";
		//echo $sql."<br>";
		$result=mysqli_query($conn,$sql);
		closeconnection($conn);
	}
